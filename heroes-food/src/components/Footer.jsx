                ...
                <div className="col-md-4 d-flex align-items-center">
                    <div className="lc-block text-center mb-3 mb-md-0">
                        <a className="navbar-brand" href="#">
                            <img className="img-fluid me-1" src="./src/assets/logo.png" alt="my brand" width="65px" height="65px" />
                        </a>

                        <a className="navbar-text text-decoration-none" href="https://wa.link/nqla6n">
